...
Untuk latihan coba kita buka file `app.component.html`.
...
Sekarang kita coba pisahkan menjadi beberapa bagian dan jadikan sebagai component. Agar terlihat rapih silahkan masukkan semua component yang akan di buat kedalam folder `pages`.
...
[Kembali](https://github.com/jutionck/angular-guideline/blob/-angular-introduction/README.md) | Berikutnya
